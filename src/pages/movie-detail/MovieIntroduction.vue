      ...
      <a-col :span="16">
        <div class="introduction">
          ...
          <div class="item">
            ...
            <span class="item-value" v-for="gen in movie.genres" :key="gen">{{ gen }}</span>
          </div>
          <div class="item">
            <span class="item-key">国家: </span>
            <span class="item-value" v-for="cou in movie.countries" :key="cou">{{ cou }}</span>
          </div>
          <div class="item">
            <span class="item-key">语言: </span>
            <span class="item-value" v-for="lan in movie.languages" :key="lan">{{ lan }}</span>
          </div>
          <div class="info">
            <span class="info-key">上映时间: </span>
            <span class="info-value">{{ concatPub(movie.pubdate) }}</span>
          </div>
          <div class="info">
